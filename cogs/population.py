...
class Population:
  ...
  def initialize(self, x, feature_intervals, indices_categorical_features, plausibility_constraints=None, temperature=0.8):
    ...
    which_from_x = np.random.choice((True,False), size=self.genes.shape, p=[1-temperature, temperature])
